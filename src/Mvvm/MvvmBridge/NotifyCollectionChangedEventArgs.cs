...
namespace System.Collections.Specialized
{
    ...
    {
        public static string NotSupported_ReadOnlyCollection = nameof(NotSupported_ReadOnlyCollection);
        internal static string IndexCannotBeNegative = nameof(IndexCannotBeNegative);
        internal static string MustBeResetAddOrRemoveActionForCtor = nameof(MustBeResetAddOrRemoveActionForCtor);
        internal static string ResetActionRequiresIndexMinus1 = nameof(ResetActionRequiresIndexMinus1);
        internal static string ResetActionRequiresNullItem = nameof(ResetActionRequiresNullItem);
        internal static string WrongActionForCtor = nameof(WrongActionForCtor) + " {0}";

        internal static string Format(string wrongActionForCtor, NotifyCollectionChangedAction action)
            => string.Format(wrongActionForCtor, action);
    }
}
